...
@Repository
public class ServiceCollectConfigurationMapper implements RepositoryProvider<ServiceCollectConfiguration>, RepositoryField {
    ...
    public List<ServiceCollectConfiguration> list() {
        ...
        return recordServiceConfigCollections.stream().map(RecordServiceConfigConvert.INSTANCE::dtoFromDao).collect(Collectors.toList());
    }
    ...
    public boolean insert(ServiceCollectConfiguration configuration) {
        RecordServiceConfigCollection recordServiceConfigCollection = RecordServiceConfigConvert.INSTANCE.daoFromDto(configuration);
