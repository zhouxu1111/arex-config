package com.arextest.config.core.handler;
...
public abstract class AbstractConfigurableHandler<T> implements ConfigurableHandler<T> {
    protected final RepositoryProvider<T> repositoryProvider;

    protected AbstractConfigurableHandler(RepositoryProvider<T> repositoryProvider) {
