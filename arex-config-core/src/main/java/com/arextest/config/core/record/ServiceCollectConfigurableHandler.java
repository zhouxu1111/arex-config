package com.arextest.config.core.record;
...
final class ServiceCollectConfigurableHandler extends AbstractConfigurableHandler<ServiceCollectConfiguration> {
    ...
    protected ServiceCollectConfigurableHandler(@Autowired RepositoryProvider<ServiceCollectConfiguration> repositoryProvider) {
